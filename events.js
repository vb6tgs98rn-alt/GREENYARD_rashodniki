...
function bindGlobalUiEvents() {
  ...
  document.getElementById('openFinanceMenuNotice')?.addEventListener('click', () => {
  alert('Раздел «Финансовый учет» подготовлен как пункт меню. Следующим шагом его нужно подключать без ломки текущей логики приложения.');
});
